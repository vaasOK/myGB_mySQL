...
CREATE TABLE game_scores(
	...
	score BIGINT COMMENT 'кол-во очков у юзера в игре',
	created_at DATETIME DEFAULT NOW() COMMENT 'первая ига юзера в игре с очками ',
    updated_at DATETIME ON UPDATE CURRENT_TIMESTAMP COMMENT 'обновление очков',
